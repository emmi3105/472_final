...
The GitHub repository for **this assignment** can be found [here](https://github.com/emmi3105/472_final).^[Note that, in our RMarkdown, we disabled the execution of the chunks containing code for automatic webscraping and sending requests to our APIs with eval=False as to prevent retrieving the data over and over again.]
